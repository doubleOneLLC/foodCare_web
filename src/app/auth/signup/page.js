  ...
  return (
    ...
    <div className ="w-[1440px] h-[1024px] flex">
        <div className ="w-[924px] h-[1024px] bg-[url(/assets/images/bg_auth.png)] bg-cover flex flex-col">
            ...
            <div className ="text-[36px] text-white ml-[67px] mt-[280px]">Buat akun untuk <br/> membantu mereka</div>
        ...
        <div className ="w-[692px] h-[1024px] bg-white rounded-tl-[32px] rounded-bl-[32px] -ml-[28px]">
            <form action="" className ="mt-[213px]">
                <label for="" className ="text-[32px] text-[#FF9531] w-auto ml-[40px]">Buat Akun</label>
                <div className ="flex flex-col mt-[38px] mx-auto w-[548px]">
                 ...
                 <div className ="w-[500px] text-center mx-auto mt-[43px] text-[16px] text-[#FF9531]">Atau gunakan akun</div>
                 ...
                 <div className ="w-[448px] h-[50px] m-auto mt-[59px] text-[16px] text-center text-[#555]">Dengan buat akun kamu menyetujui <a className ="underline-[none] text-[#FF9531] hover:underline hover:cursor-pointer">Syarat & <br/>Ketentuan</a> dan <a className ="underline-[none] text-[#FF9531] hover:underline hover:cursor-pointer">Kebijakan Privasi</a> sitename.</div>
                 <div className ="w-[296px] h-[45px] text-[#555] mt-[28px] m-auto text-center">Sudah punya akun? <a href="#" className ="text-[#FF9531] hover:underline-[none] hover:underline">Login aja</a></div>
            </form>
        </div>
    </div>
    </>
